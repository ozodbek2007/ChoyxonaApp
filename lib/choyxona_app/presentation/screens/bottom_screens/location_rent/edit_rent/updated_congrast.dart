...
class UpdateCongratsPlace extends StatelessWidget {
  const UpdateCongratsPlace({super.key,required this.restnt});
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const Gap(10),
          Text("Sizning joyingiz o'zgartirildi!",style: TextStyles.descTextStyle),
          const Gap(50),
